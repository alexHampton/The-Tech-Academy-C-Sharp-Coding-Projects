...
{
    public class SchoolInitializer : DropCreateDatabaseIfModelChanges<SchoolContext> //Will drop data from DB if model changes. But this initializer will then update with the test data below.
    {
        protected override void Seed(SchoolContext context)
        {
            var students = new List<Student>
            {
                new Student{FirstMidName="Alexander", LastName="Carson", EnrollmentDate=DateTime.Parse("2015-09-01")},
